...
import           Domain.Converter.Units.ToRawReactionDetailsSpec (toRawReactionDetailsSpec)
...
main =
  hspec $ do
    ...
    describe "Domain.Converter.Units.ToRawReactionDetails" toRawReactionDetailsSpec
